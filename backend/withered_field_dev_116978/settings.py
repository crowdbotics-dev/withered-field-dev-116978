"""
Django settings for withered_field_dev_116978 project.
...
ROOT_URLCONF = 'withered_field_dev_116978.urls'
...
WSGI_APPLICATION = 'withered_field_dev_116978.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_field_dev_116978 API",
    "DESCRIPTION": "API documentation for withered_field_dev_116978 App",
    "VERSION": "v1",
}
