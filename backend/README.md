...
## Project Structure
    ...
    ├── withered_field_dev_116978  # Django project configurations
...
1. Clone this repo and `cd withered_field_dev_116978`
...
2. Clone this repo and `cd withered_field_dev_116978`
